...
public class ZCacheScanner {
	...
	public static void scan(final ZApplicationStartupInfo startupInfo) {
		...
		ZContext.addBean(ICacheableRoute.class, G.newInstance(G.load("vo.vortex.generated.maven.ZCacheableRoute")));
		ZContext.addBean(ICachePutRoute.class, G.newInstance(G.load("vo.vortex.generated.maven.ZCachePutRoute")));
		ZContext.addBean(ICacheEvictRoute.class, G.newInstance(G.load("vo.vortex.generated.maven.ZCacheEvictRoute")));
