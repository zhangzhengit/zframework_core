...
import vo.vortex.enums.ZSessionStorageTypeEnum;
import vo.vortex.http.PortChecker;
import vo.vortex.http.ZHeader;
import vo.vortex.validator.StaticResourcePreCompressionAlgorithmValidator;
import vo.vortex.validator.ZClientQPSValidator;
import vo.vortex.validator.ZHttpMethodValidator;
import vo.vortex.validator.ZServerQPSValidator;
import vo.vortex.validator.ZSessionIdQPSValidator;
import vo.vortex.validator.ZSessionStorageTypeValidator;
...
public class ServerConfigurationProperties {
	...
	private Set<String> staticResourcePreCompressionAlgorithm = CU.ofSet(
	 ...
	 */
	@ZNotEmtpy
	private Set<String> staticResourcePreCompressionSuffix = CU.ofSet(
			"html", "htm", "css", "js", "mjs",
